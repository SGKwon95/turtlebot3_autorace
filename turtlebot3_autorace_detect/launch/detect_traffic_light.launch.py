...
def generate_launch_description():
    ...
    detect_traffic_light_node = Node(
        ...
        remappings=[
            ...
            ('/detect/image_output_sub3', '/detect/image_purple_light'),
            ('/detect/image_output_sub3/compressed', '/detect/image_purple_light/compressed'),
            ('/detect/image_output_sub4', '/detect/image_green_light'),
            ('/detect/image_output_sub4/compressed', '/detect/image_green_light/compressed'),
        ],
    )
